...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        ...
        retVal = mineRefactor(handPos, currentPlayer, choice1, choice2, state);
    ...
    case baron:
        //return baronRefactor(choice1, currentPlayer, state);
        retVal = baronRefactor(choice1, currentPlayer, state);
        state->numBuys++;//Increase buys by 1!
        if (choice1 > 0) { //Boolean true or going to discard an estate
            int p = 0;//Iterator for hand!
            int card_not_discarded = 1;//Flag for discard set!
    ...
    case minion:
        ...
        retVal = minionRefactor(handPos, currentPlayer, choice1, choice2, state);
    ...
    case tribute:
        ...
        retVal = tributeRefactor(currentPlayer, nextPlayer, tributeRevealedCards, state);
    ...
    case ambassador:
        ...
        retVal = ambassadorRefactor(handPos, currentPlayer, choice1, choice2, state);
